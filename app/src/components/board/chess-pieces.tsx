...
// Using free chess piece icons inspired by Wikimedia Commons
...
export function KingIcon({ className, color }: ChessPieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
...
export function QueenIcon({ className, color }: ChessPieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
      className={cn("w-full h-full", className)}
    ...
    >
      ...
      >
        ...
        <path d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 0.5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5 0.5 2.5 0.5 2.5 6.5 1 16.5 1 23 0 0 0 1.5-1 0-2.5 0 0 0.5-1.5-1-2.5-0.5-2.5-0.5-2 0.5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z" />
...
export function RookIcon({ className, color }: ChessPieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
      className={cn("w-full h-full", className)}
...
export function BishopIcon({ className, color }: ChessPieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
      className={cn("w-full h-full", className)}
...
export function KnightIcon({ className, color }: ChessPieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
      className={cn("w-full h-full", className)}
...
export function PawnIcon({ className, color }: ChessPieceProps) {
  return (
    <svg
      viewBox="0 0 45 45"
      className={cn("w-full h-full", className)}
...
export function ChessPiece({ type, color, className }: { type: string; color: 'white' | 'black'; className?: string }) {
  ...
  const PieceComponent = pieceComponents[type.toLowerCase() as keyof typeof pieceComponents];
